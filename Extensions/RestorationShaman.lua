	...
	[114052] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/ascendance.ogg",		nil,	true }
		}
	},
	[108271] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/astral_shift.ogg",		nil,	true }
		}
	},
	[192058] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/capacitor_totem.ogg",		nil,	true }
		}
	},
	[204331] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/counterstrike_totem.ogg",		nil,	true }
		}
	},
	[198103] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/earth_elemental.ogg",		nil,	true }
		}
	},
	[2484] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/earthbind_totem.ogg",		nil,	true }
		}
	},
	[198838] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/earthen_wall_totem.ogg",		nil,	true }
		}
	},
	[51485] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/earthgrab_totem.ogg",		nil,	true }
		}
	},
	[73920] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/healing_rain.ogg",		nil,	true }
		}
	},
	[5394] = {
		{
			...
			{nil,		AUDIOQS.SOUND_FUNC_PREFIX.."if select(4, GetTalentInfo(6, 3, 1)) then return '"..AUDIOQS.SOUNDS_ROOT.."Cooldowns/cloudburst_totem.ogg' end return '"..AUDIOQS.SOUNDS_ROOT.."Cooldowns/healing_stream_totem.ogg'",		nil,	true }
		}
	},
	[108280] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/healing_tide_totem.ogg",		nil,	true }
		}
	},
	[51514] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/hex.ogg",		nil,	true }
		}
	},
--[[[77130] = { -- Purify Spirit
		{
	...
	[98008] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/spirit_link_totem.ogg",		nil,	true }
		}
	},
	[79206] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/spiritwalkers_grace.ogg",		nil,	true }
		}
	},
	[8143] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/tremor_totem.ogg",		nil,	true }
		}
	},
	[73685] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/unleash_life.ogg",		nil,	true }
		}
	},
	[57994] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/wind_shear.ogg",		nil,	true }
		}
	},
--[[[974] = { -- Earth Shield Drop (Unfinished) TODO Requires tracking of GUID of player with earthshield on them. UNIT_AURA checking if the ES has dropped from that player.
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/earth_shield_drop.ogg",		nil,	true }
		}
	},]]--
	[207399] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/ancestral_protection_totem.ogg",		nil,	true }
		}
	},
	[192077] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/wind_rush_totem.ogg",		nil,	true }
		}
	},
	[207778] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/downpour.ogg",		nil,	true }
		}
	},
	[197995] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/wellspring.ogg",		nil,	true }
		}
	},
	[204336] = {
		{
			...
			{nil,		AUDIOQS.SOUND_PATH_PREFIX..AUDIOQS.SOUNDS_ROOT.."Cooldowns/grounding_totem.ogg",		nil,	true }
		}
	},
